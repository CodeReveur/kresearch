    ...
    <div className="w-full h-full flex justify-center items-center">
      <div className="flex flex-col justify-center items-center p-4 rounded-xl w-[60vw] gap-5">
        ...
        <form action="/w-page/result" method="GET" className="flex justify-center w-full">
          <input type="search" name="search" id="" placeholder="Search for researches ..." className="w-[80%] text-gray-100 placeholder:text-gray-300 placeholder:font-semibold border outline-none rounded-s-md border-r-0 px-4 py-2 bg-transparent border-slate-50"/>
        ...
        <h4 className="text-center py-3 font-medium">If it's not here, you don't need it</h4>
        </div>
